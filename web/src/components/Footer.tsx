    ...
    <footer className="bg-dark border-t border-offwhite/5">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a href="#" className="text-offwhite/30 transition-colors hover:text-gold" aria-label="Discord">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-offwhite/30 transition-colors hover:text-gold" aria-label="Telegram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-semibold uppercase tracking-wider text-offwhite/60">
                {category}
              </h4>
        ...
        <div className="mt-12 border-t border-offwhite/5 pt-8">
          <p className="text-center text-xs text-offwhite/30">
