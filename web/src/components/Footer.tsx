...
export default function Footer() {
  return (
    <footer className="bg-dark border-t border-offwhite/5">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a href="https://x.com/BrixUpHQ" target="_blank" rel="noopener noreferrer" className="text-offwhite/50 transition-colors hover:text-gold" aria-label="Twitter / X">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://discord.gg/brixup" target="_blank" rel="noopener noreferrer" className="text-offwhite/50 transition-colors hover:text-gold" aria-label="Discord">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://t.me/BrixUpHQ" target="_blank" rel="noopener noreferrer" className="text-offwhite/50 transition-colors hover:text-gold" aria-label="Telegram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-semibold uppercase tracking-wider text-offwhite/80">
                {category}
              </h4>
